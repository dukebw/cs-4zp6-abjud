...
{Udip Patel}
{The web interface shall be able to recognize when the set of inputs is invalid, and shall alert the user with a error message right away}
{High}
{Created October 11th, 2016.}
...
There are currently no plans to adapt the McMaster Text-to-Motion software to
any platform besides those mentioned in constraints \ref{Constraint_Linux} and
\ref{Constraint_PythonAPI}.  Therefore we do not consider adaptability
requirements in the scope of this document.
