...
While training the network PCKh values are automatically stored and saved in order to see the progression of the deep learning algorithm. Below is a plot of the accuracy that was achieved versus the number of tests ran. 
