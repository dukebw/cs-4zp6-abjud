...
\chapter{Decomposition of Modules}

\section{ASP.NET Web Application}
...
\begin{enumerate}
    ...
    ...
    \item \textbf{Text to Motion Search:}

    ...
    \item \textbf{Image Pose Draw - Create:}

    ...
    \item \textbf{Image Pose Draw - Edit:}

    ...
    \item \textbf{Image Pose Draw - View Uploads:}
...
\section{Caffe-Human Pose Estimation}

    \subsection{Shared Object Functions}
    ...description of function that is used to implement skeleton overlay...
