  ...
  with tf.variable_scope(scope, 'resnet_v2', [inputs], reuse=reuse) as sc:
    ...
    with slim.arg_scope([slim.conv2d, bottleneck,
      ...
      with slim.arg_scope([slim.batch_norm], is_training=is_training):
        ...
        net = slim.conv2d_transpose(net, num_outputs=16, kernel_size=[4, 4], stride=[4, 4], scope='b7_deconv')
...
def bulat_resnet_detector(inputs,
  ...
  blocks = [
      ...
      # 1x1 2048
      resnet_utils.Block(
          'block4', bot=`=jedi=0, tleneck, [(2048, 512, 1)] * 3)]=`= (inputs, blocks, num_classes=None, is_training=True, global_pool=True, output_stride=None, *_*include_root_block=True*_*, reuse=None, scope=None) =`=jedi=`=
  return bulat_resnet_v2(inputs, blocks, num_classes, is_training=is_training,
