...
def vgg_16_graham_base(inputs, num_classes, dropout_keep_prob, is_training):
    """Base of the VGG-16 network (fully convolutional).
    ...
    a6 = slim.dropout(a5, dropout_keep_prob, is_training=is_training,
                      scope='dropout7')

    a7  = slim.conv2d(a6, num_classes, [1, 1], activation_fn=None, normalizer_fn=None, scope='fc8')
...
def _vgg_16_bn_relu_graham(inputs,
                           num_classes=16,
                           is_training=True,
                           dropout_keep_prob=0.5,
                           batch_norm_var_collection='moving_vars',
        ...
        with tf.name_scope(scope):
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d],
                ...
                with slim.arg_scope([slim.conv2d],
                    ...
                    a3, a4, a8 = vgg_16_base_graham(inputs,
                                                    num_classes,
                                                    dropout_keep_prob,
                                                    is_training)
...
def graham_vgg(inputs,
    ...
    """
    return _vgg_16_bn_relu_graham(inputs=inputs,
                                  num_classes=num_classes,
                                  is_training=is_detector_training,
                                  scope='vgg_16')
...
def graham_cascade(inputs,
    ...
    regression_logits, _ = resnet_bulat.res(inputs=stacked_heatmaps,
                                                  num_classes=num_classes,
